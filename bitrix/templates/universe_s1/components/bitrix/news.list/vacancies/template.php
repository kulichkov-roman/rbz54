                                        ...
                                        <div class="vacancies-item-description">
                                            ...
                                            <?php if ($bShowSummaryForm) { ?>
                                                <div class="vacancies-item-description-buttons">
                                                    <div class="intec-button intec-button-cl-common intec-button-md" data-name="<?= Html::encode($arItem['NAME']) ?>" data-action="form"><?= GetMessage('N_L_VACANCIES_FORM_SUMMARY') ?></div>
                                                </div>
                                            <?php } ?>
                                        </div>
                                    </div>
