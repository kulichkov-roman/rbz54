...
if (!empty($arResult['ITEMS']))
{
    ...
    foreach ($arResult["ITEMS"] as $elementKey => $arElement) {
        ...
        if (!empty($arElement['PREVIEW_PICTURE'])) {
            $picture = CFile::ResizeImageGet($arElement['PREVIEW_PICTURE']['ID'], array('width' => 240, 'height' => 240, BX_RESIZE_IMAGE_PROPORTIONAL_ALT));
            ...
            $picture = CFile::ResizeImageGet($arElement['DETAIL_PICTURE']['ID'], array('width' => 240, 'height' => 240, BX_RESIZE_IMAGE_PROPORTIONAL_ALT));
