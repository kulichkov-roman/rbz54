    ...
    <div class="intec-content-wrapper">
        ...
        <? $ElementID = $APPLICATION->IncludeComponent(
            ...
            array(
                ...
                'REVIEWS_IBLOCK' => $arParams['REVIEWS_IBLOCK'],
                'REVIEWS_PROPERTY_ELEMENT_ID' => $arParams['REVIEWS_PROPERTY_ELEMENT_ID'],
                'REVIEWS_MAIL_EVENT' => $arParams['REVIEWS_MAIL_EVENT'],
                'REVIEWS_USE_CAPTCHA' => $arParams['REVIEWS_USE_CAPTCHA'],
                'WEB_FORM' => $arParams['WEB_FORM'],
                ...
                'PROPERTY_BUYING' => $arParams['PROPERTY_BUYING'],
                ...
                'VIDEO_IBLOCK_PROPERTY' => $arParams['VIDEO_IBLOCK_PROPERTY'],
