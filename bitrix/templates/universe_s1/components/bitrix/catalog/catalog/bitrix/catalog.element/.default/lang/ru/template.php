...
$MESS["TAB_DESCRIPTION"] = "Описание";
$MESS["TAB_CHARACTERISTICS"] = "Характеристики";
$MESS["ALL_CHARACTERISTICS"] = "Все характеристики";
$MESS["TAB_DOCUMENTS"] = "Документы";
$MESS["TAB_VIDEO"] = "Видео";
$MESS["TAB_REVIEWS"] = "Отзывы";
$MESS["RECOMENDATIONS"] = "Персональные рекомендации";
$MESS["BUYING_WITH"] = "C этим товаром покупают";
$MESS["IS_NEW"] = "Новинка";
$MESS["IS_POPULAR"] = "Хит";
$MESS["IS_RECOMMENDATION"] = "Советуем";
$MESS["BUY_IN_ONE_CLICK"] = "Купить в 1 клик";

$MESS['CE_FAST_ORDER'] = 'Быстрый заказ';
