...
<?if (!empty($arResult['ITEMS'])) {?>
    ...
    <? } ?>
    <!-- items-container -->
    <div class="intec-catalog-section intec-catalog-section-text" data-entity="<?=$containerName?>">
        <?
            ...
            <div id="<?=$this->GetEditAreaId($arElement['ID']);?>"
                ...
                <div class="element-catalog">
                    ...
                    <div class="price-block">
                        ...
                        ?>
                        <div class="newprice">
                            <?=($flg_offers && !empty($newprice))? GetMessage('PRICE_FROM'):''?> <?=$newprice?>
                        </div>
                        <?if ($useDiscount) {?>
                            <div class="oldprice">
                                <?=$oldprice?>
                    ...
                    <?if ($arElement['CAN_BUY'] && !$flg_offers) {?>
                        <div class="buys">
                            <div class="intec-button intec-button-w-icon intec-button-transparent intec-button-md intec-button-fs-16 intec-button-cl-common add"
                            ...
                            <a href="<?= $arParams['BASKET_URL'] ?>" class="intec-button intec-button-w-icon intec-button-md intec-button-fs-16 intec-button-cl-common added"
                    ...
                    <?}else if($flg_offers && $flg_offers_can_buy) {?>
                        <div class="buys">
                            <a href="<?=$arElement['DETAIL_PAGE_URL']?>" class="intec-button intec-button-w-icon intec-button-transparent intec-button-md intec-button-fs-16 intec-button-cl-common" data-product-id="<?=$arElement['ID']?>" data-quantity="1">
                                <span class="intec-button-icon intec-basket glyph-icon-cart"></span>
