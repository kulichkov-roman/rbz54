...
$isNew = !empty($arResult['PROPERTIES'][$arParams['PROPERTY_IS_NEW']]) && $arResult['PROPERTIES'][$arParams['PROPERTY_IS_NEW']]['VALUE'];
$isPopular = !empty($arResult['PROPERTIES'][$arParams['PROPERTY_IS_POPULAR']]) && $arResult['PROPERTIES'][$arParams['PROPERTY_IS_POPULAR']]['VALUE'];
$isRecommendation = !empty($arResult['PROPERTIES'][$arParams['PROPERTY_IS_RECOMMENDATION']]) && $arResult['PROPERTIES'][$arParams['PROPERTY_IS_RECOMMENDATION']]['VALUE'];
