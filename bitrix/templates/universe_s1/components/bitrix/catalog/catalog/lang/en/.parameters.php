...
$MESS['OFFERS_PROPERTIES_MODE'] = 'Offers properties view';
$MESS['OFFERS_PROPERTIES_MODE_COLOR'] = 'color';
$MESS['OFFERS_PROPERTIES_MODE_TEXT'] = 'text';
$MESS['OFFERS_PROPERTIES_MODE_COLOR_TEXT'] = 'text and color';
$MESS['DETAIL_PICTURE_POPUP'] = 'Popup for detail image';
$MESS['DETAIL_PICTURE_POPUP_SETTINGS'] = 'Template settings';
$MESS['DETAIL_PICTURE_POPUP_Y'] = 'On';
$MESS['DETAIL_PICTURE_POPUP_N'] = 'Off';
$MESS['DETAIL_PICTURE_LOOP'] = 'Loop for detail image';
$MESS['DETAIL_PICTURE_LOOP_SETTINGS'] = 'Template settings';
$MESS['DETAIL_PICTURE_LOOP_Y'] = 'On';
$MESS['DETAIL_PICTURE_LOOP_N'] = 'Off';
$MESS['DETAIL_VIEW'] = 'Detail view';
$MESS['DETAIL_VIEW_TABLESS'] = 'Without tabs';
$MESS['DETAIL_VIEW_TABS'] = 'With tabs';
$MESS['DETAIL_VIEW_TABS_BOTTOM'] = 'With bottom tabs';
$MESS['DETAIL_VIEW_TABS_RIGHT'] = 'With right tabs';
$MESS['REVIEWS_IBLOCK_TYPE'] = 'Reviews infoblock type';
$MESS['REVIEWS_IBLOCK'] = 'Reviews infoblock';
$MESS['REVIEWS_MAIL_EVENT'] = 'Reviews mail event';
$MESS['REVIEWS_PROPERTY_ELEMENT_ID'] = 'Reviews element binding property';
$MESS['REVIEWS_USE_CAPTCHA'] = 'Use captcha in reviews';
$MESS['WEB_FORM'] = 'Web form';
$MESS['WEB_FORM_USE_CAPTCHA'] = 'Use captcha in web-form';
$MESS['PROPERTY_ARTICLE'] = 'Property article';
$MESS['PROPERTY_BRAND'] = 'Property brand';
$MESS['PROPERTY_VIDEO'] = 'Property video';
$MESS['PROPERTY_DOCUMENTS'] = 'Property documents';
$MESS['PROPERTY_RECOMENDATIONS'] = 'Property recomendations';
$MESS['PROPERTY_BUYING'] = 'Property popular products';
$MESS['PROPERTY_IS_NEW'] = 'Property new product';
$MESS['PROPERTY_IS_POPULAR'] = 'Property popular product';
$MESS['PROPERTY_MORE_PHOTO'] = 'Property more photo';
$MESS['VIDEO_IBLOCK_TYPE'] = 'Video infoblock type';
$MESS['VIDEO_IBLOCK_ID'] = 'Video infoblock id';
$MESS['VIDEO_IBLOCK_PROPERTY'] = 'Property link to video';
$MESS['OFFERS_PROPERTY_MORE_PHOTO'] = 'Offers property more photo';

$MESS['CE_DEFAULT_TEMPLATE'] = 'Built-in template';
$MESS['CE_USE_FAST_ORDER'] = 'Use fast order';
$MESS['CE_FAST_ORDER_TEMPLATE'] = 'Fast order template';
$MESS['CE_FAST_ORDER_TITLE'] = 'Fast order title';
$MESS['CE_FAST_ORDER_SEND_BUTTON'] = 'Fast order button text';
$MESS['CE_FAST_ORDER_SHOW_COMMENT'] = 'Show comment to fast order';
$MESS['CE_FAST_ORDER_PRICE_TYPE'] = 'Fast order price type';
$MESS['CE_FAST_ORDER_DELIVERY_TYPE'] = 'Fast order delivery type';
$MESS['CE_FAST_ORDER_PAYMENT_TYPE'] = 'Fast order payment type';
$MESS['CE_FAST_ORDER_PAYER_TYPE'] = 'Fast order payer type';
$MESS['CE_FAST_ORDER_SHOW_PROPERTIES'] = 'Fast order show properties';
$MESS['CE_FAST_ORDER_PROPERTY_PHONE'] = 'Fast order property phone';