...
<?php if (!empty($arResult)) { ?>
    <div id="<?= $sTemplateId ?>" class="menu menu-header-mobile">
        <div class="menu-button" data-role="button">
            <div class="intec-aligner"></div>
            <div class="menu-button-icon glyph-icon-menu-icon<?= $arParams['MOBILE_VIEW'] == 'default' ? ' intec-cl-text' : null ?>"></div>
            <div class="menu-button-icon menu-button-icon-active fa fa-times<?= $arParams['MOBILE_VIEW'] == 'default' ? ' intec-cl-text' : null ?>"></div>
        </div>
